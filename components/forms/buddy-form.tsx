...
import { signupBuddy } from "@/lib/actions/auth";
...
export function BuddyForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await signupBuddy({
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            id="major"
            name="major"
            placeholder="e.g., Data Science, Sociology"
            required
            disabled={isLoading}
          />
        </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="looking_for"
          name="looking_for"
          placeholder="Describe what kind of research buddy or collaboration you're seeking..."
          rows={3}
          required
          disabled={isLoading}
        />
      ...
      <Button type="submit" className="w-full" disabled={isLoading}>
        {isLoading ? "Creating account..." : "Create Research Buddy Account"}
      </Button>
    </form>
  );
}
